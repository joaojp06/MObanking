    ...
    try:
        ...
        if db.is_connected():
            ...
            with db.cursor() as cursor:
                ...
                query4 = ("insert into limite_servico_monitorado (fkServidor, fkServico, valor, unidadeMedida) values (%s, 1, 0, '%');")
                value4 = [idMaquina]  
                cursor.execute(query4, value4)
                print(cursor.rowcount, "registro inserido na tabela limite servico - Intermediario Pro")
                
                query5 = ("insert into limite_servico_monitorado (fkServidor, fkServico, valor, unidadeMedida) values (%s, 2, 0, '%');")
                value5 = [idMaquina]  
                cursor.execute(query5, value5)
                print(cursor.rowcount, "registro inserido na tabela limite servico - Intermediario Pro")
                
                query6 = ("insert into limite_servico_monitorado (fkServidor, fkServico, valor, unidadeMedida) values (%s, 3, 0, 'GB');")
                value6 = [idMaquina]  
                cursor.execute(query6, value6)
                print(cursor.rowcount, "registro inserido na tabela limite servico - Intermediario Pro")
                
                query7 = ("insert into limite_servico_monitorado (fkServidor, fkServico, valor, unidadeMedida) values (%s, 4, 0, 'MB');")
                value7 = [idMaquina]  
    ...
    try:
        ...
        if db.is_connected():
            ...
            with db.cursor() as cursor:
                ...
                query4 = ("insert into limite_servico_monitorado (fkServidor, fkServico, valor) values (%s, 1, 0);")
                value4 = [idMaquina]  
                cursor.execute(query4, value4)
                print(cursor.rowcount, "registro inserido na tabela limite servico - basico")
                
                query5 = ("insert into limite_servico_monitorado (fkServidor, fkServico, valor) values (%s, 2, 0);")
                value5 = [idMaquina]  
                cursor.execute(query5, value5)
                print(cursor.rowcount, "registro inserido na tabela limite servico - basico")
            ...
            with db.cursor() as cursor:
                ...
                if result:
                    ...
                    if plano == 1:
                        ...
                        print("Plano Pro ou intermediario ok - NOVA MÁQUINA")
            ...
            with db.cursor() as cursor:
                ...
                if result:
                    ...
                    if plano == 1:
                        ...
                        print("Plano Pro ou intermediario ok da MÁQUINA EXISTENTE")
...
webhook_url = "https://hooks.slack.com/services/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"
