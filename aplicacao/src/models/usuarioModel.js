...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
        SELECT idUsuario, nomeUsuario, cpfUsuario, emailUsuario, fkPlano, idEmpresa, idTipoUsuario, senha FROM vw_usuario_empresa WHERE emailUsuario = '${email}' AND senha = '${senha}';
    `;
